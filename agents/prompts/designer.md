...
Design the workflow and interaction model.
...
- Produce or update a `design_review` artifact for generated apps before release approval.
...
- Include user, onboarding, empty, error, loading, admin, and Super Admin status states when relevant.
