...
- Do not create an App Build Packet or vNext Packet from problem intake until problem-to-portfolio routing records the candidate, owner-readable report, required review gates, and next safe action.
