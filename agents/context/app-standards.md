...
- Keep customer/admin auth, Identity/Auth plans, Super Admin registry entries, provider/cost reviews, Deployment Environment plans, Design Intent profiles, Design Quality Gates, UX Reviews, Compatibility Test Plans, Release Gates, Neon persistence, generated app export, QA, and deployment gates aligned.
...
- Do not generate UI from generic taste; capture design intent first so audience, feeling, trust, accessibility, and visual preference guide the work.
