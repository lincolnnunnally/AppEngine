...
runStep("both intake doors stay reachable from the entry surface", () => {
  ...
  assertFileIncludes("src/app/page.tsx", ["PublicFactoryHome", "OwnerCommandDeck", "isDashboardRequest"]);
  assertFileIncludes("src/app/(cockpit)/start/page.tsx", ['redirect("/")']);
  assertFileIncludes("src/components/intake/public-factory-home.tsx", ["ConversationalIntake"]);
