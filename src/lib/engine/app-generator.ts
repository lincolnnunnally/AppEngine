...
function buildSchemaSql(selected?: Set<string>) {
  return baseSchemaSql() + foundationSchemaSql() + "\n" + composeModuleSchemaSql(selected) + "\n";
}
