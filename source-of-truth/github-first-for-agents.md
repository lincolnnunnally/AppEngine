# GitHub first for agents (including Grok Build)

**Owner directive (Lincoln, 2026-09-10).**

GitHub is the source of truth. Isolated Grok Build sandboxes are not.

Before any agent plans, scaffolds, or ships an app:

1. Search `user:lincolnnunnally` on GitHub (private repos + naming variations).
2. Read `agents/context/source-of-truth.md` and `source-of-truth/app-selection-standard.md`.
